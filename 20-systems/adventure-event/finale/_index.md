...
- **独立胜负条件的具体改写值：** **承载已定案**（回合数与胜负条件是遭遇参数、Finale 整体更难）；仍待定**拧到什么程度**——门槛取什么形式（必须领先 N 点？更少回合？）、失败是否直接 defeated、奖励结构如何相应加厚。→ `20-systems/scoring.md`、`20-systems/services/combat-service.md`。Source: `10-handoffs/2026-08-02-momentum-conversion-reward-structure-and-mtg-stack.md`。
