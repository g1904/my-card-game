...
| `open-questions/01-combat.md` | **① 战斗机制**（焦点之首）：战斗结构残留、等级与意图、结构与存档、战斗内容与规则。 |
| `open-questions/02-event-options.md` | **② eventOptions 生成流程**：生成 / 加权、物化字段、跳过与优先级、`CostKey`、`pastEvent`。 |
