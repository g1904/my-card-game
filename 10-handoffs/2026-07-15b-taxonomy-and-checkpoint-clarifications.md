...
→ 应你要求定为决策，见 `50-decisions/ADR-0002-adventure-event-taxonomy.md`。
...
## Open questions
- **篇章间继承什么？** 读档续章时，角色带入下一篇章的具体内容（deck、relics/法宝、属性、叙事标记）仍未逐项敲定。→ `20-systems/map-progression.md`、`run-manager.md`。
