...
- date: 2026-07-26
- topic: 20-systems/adventure-event/common-properties, 20-systems/services/future-event-service, 20-systems/services/content-service, 20-systems/common-properties, 20-systems/player-profile, 20-systems/balance, 20-systems/architecture, 40-ux/screen-flow, terminology
- status: distilled
- distilled-to: terminology.md, 20-systems/adventure-event/common-properties.md, 20-systems/services/future-event-service.md, 20-systems/services/content-service.md, 20-systems/services/life-cycle-service.md, 20-systems/common-properties.md, 20-systems/architecture.md, 20-systems/balance.md, 20-systems/player-profile/**（新增 achievements/、account-info.md、game-setting.md）, 40-ux/screen-flow.md, open-questions.md, .claude/rules/state-save-rules.md
...
- **元婴界面（通关证书）的具体形态。** 它展示哪些字段（最终寿元、用时、修行历程摘要、成就？）、何时弹出、是否可回看 / 分享——均未定。→ `40-ux/screen-flow.md`。
- **寿元红字倒数的呈现细节。** 「倒数」是随每次事件结算逐格递减的数字，还是持续跳动的计时感？它常驻哪些屏幕（选择区 / 战斗内 / 全局 HUD）？是否伴随音效 / 震动？→ `40-ux/screen-flow.md`、`40-ux/combat-ux.md`。
