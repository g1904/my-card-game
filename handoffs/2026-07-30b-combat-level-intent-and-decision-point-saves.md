...
- status: distilled
- distilled-to: terminology.md, program-overview.md, systems/architecture.md, systems/common-properties.md, systems/game-progression.md, systems/balance.md, systems/services/_index.md, systems/services/combat-service.md, systems/services/life-cycle-service.md, systems/adventure-event/combat/_index.md, systems/adventure-event/practice/_index.md, systems/adventure-event/finale/_index.md, systems/character-profile/_index.md, systems/character-profile/mana.md, systems/character-profile/deck/_index.md, systems/player-profile/_index.md, systems/player-profile/enemy-codex/（新增）, ux/combat-ux.md, open-questions.md, answer-logs/log-0730b.md
