...
目标文档：`20-systems/services/content-service.md`、`sync-service.md`、`account-service.md`、`plot-manager.md`、`life-cycle-service.md`、`20-systems/common-properties.md`、`20-systems/character-profile/`、`00-vision/scope.md`。
...
- **`00-vision/scope.md` 第 10 / 57 行**仍写「轮回带 seed 且可复现，便于复现 bug」——已被 07-26 决策推翻，改写为：**同一 `contentVersion` 内可复现；跨版本以存档记录的 `contentVersion` 归因**。
