...
- possibleFutureEvent is a service that produce event options based on the current characterProfile.
- to make service more clear, let's refactor adventurePlot into adventure-plot-service, possibleFutureEvent into future-event-service, and run-manager into life-cycle-service.
