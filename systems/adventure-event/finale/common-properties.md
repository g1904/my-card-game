...
- **境界跃迁标记。** 一个 Finale 事件对应一次境界突破（篇章边界），关联目标境界（筑基 / 金丹 / 元婴）。Source: `terminology.md`、`systems/adventure-event/_index.md`。
- **独立结算钩子。** Finale 走独立于 Combat 的境界突破结算。Source: `systems/adventure-event/_index.md`。
