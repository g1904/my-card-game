...
- **独立胜负条件的具体改写值：** **承载已定案**（回合数与胜负条件是遭遇参数、Finale 整体更难）；仍待定**拧到什么程度**——门槛取什么形式（必须领先 N 点？更少回合？）、失败是否直接 defeated、奖励结构如何相应加厚。→ `systems/scoring.md`、`systems/services/combat-service.md`。Source: `handoffs/2026-08-02-momentum-conversion-reward-structure-and-mtg-stack.md`。
- **非战斗形态的 Finale：** 哪些境界突破走非战斗路径、其结算形态如何，留待日后定制。
- **天劫的等级与意图档位：** 天劫作为 Enemy 带等级；篇章边界的天劫是否天然属于「大幅越级」（即完全无意图信息）未定——这会直接决定 Finale 的信息压迫感。→ `systems/services/combat-service.md`。
