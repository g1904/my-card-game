...
- **敌人数据 schema：** 敌人字段（等级、道念产出能力、intent 列表、行为脚本、缩放）未定义。Source: `handoffs/2026-08-01-momentum-scoring-lifespan-tuning-and-failure-payoff.md`。
- **回合结构细节：** 抽 / 弃 / 出牌顺序、**战斗终止条件**（回合上限 / 道念阈值 / 卡组耗尽）等未定。→ 见 `_index.md`、`systems/scoring.md` 与 `systems/character-profile/mana.md`。
